...
<?php include('header.php'); ?>
	...
	<div class="search" style="background-color:;">
		<h3 class="text-center" style="background-color:#272327;color: #fff;padding: 10px;">Customer Details</h3>

			<div class="formstyle" class="formstyle" style="padding: 15px;border: 1px solid lightgrey;margin-right: 376px;margin-left: 406px; margin-bottom: 25px;background-color:#f3f3f8;color:#141313;">
