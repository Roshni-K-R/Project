<?php include('header.php'); ?>
	...
	<div class="doctors">
		                    ...
		                    <h3 class="text-center" style="background-color:#272327;color: #fff;">Doctors of Bangalore</h3>
                            <div class="col-md-12" style="">
                                  


                                  <div class="col-md-3">
                                      <img src="img/ROSHNI.webp" alt="" class="img-responsive" style="width: 220px;height: 270px">
                                  </div> <br>

                                  <div class="col-md-3" > 

                                     
                                     <h3 style="color:#0616BC;">Dr. Roshni K R</h3>
                                 ...
                                 <div class="col-md-3">
                                      <img src="img/AFREEN.jpg" alt="" class="img-responsive" style="width: 220px;height: 270px"> <br>
                                  </div>

                                  <div class="col-md-3">
                                       
                                       <h3 style="color:#0616BC;">Dr. Afreen</h3>
...
Gynecologist & Obestetrics
                            ...
                            <br><br>
                             ...
                             <div class="col-md-12" style="">
                                  ...
                                  <div class="col-md-3">
                                      <img src="img/MEHTA.jpg" alt="" class="img-responsive" style="width: 220px;height: 220px">
                                  </div>

                                  <div class="col-md-3" > 

                                     
                                     <h3 style="color:#0616BC;">Dr. Harshad Meheta</h3>
...
Expertise: Brain, Nerve & Spine, Neuro-Surgeon
                                 ...
                                 <div class="col-md-3">
                                  ...
                                  <div class="col-md-3">
                                       ...
                                       <h3 style="color:#0616BC;">Dr. Charan Raj</h3>
